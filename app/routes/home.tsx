    ...
    <main className="flex flex-1 justify-center flex-col items-center gap-4">
      <div id="quote-box" className="flex flex-col items-center justify-center p-8 bg-slate-800 rounded-xl gap-2">
        ...
        <div className="flex gap-4 mt-8">
          ...
          <a id="tweet-quote" className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors" target="_blank" href={`https://twitter.com/intent/tweet?text=$ ${num.toFixed(2)} - ${author}`}>
            Tweet
          </a>
        </div>
      </div>
